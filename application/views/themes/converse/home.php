...
<section id="home-section" class="hero">
    <div class="home-slider owl-carousel">
            ...
            <div class="container">
                <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
                    ...
                    <div class="col-md-12 ftco-animate text-center">
                        <h1 class="mb-2">Kami Menjual Makeup Dengan Harga Terbaik</h1>
                        <h2 class="subheading mb-4">Brand yang Teruji dan Berkualitas</h2>
        ...
        <div class="slider-item"
            style="background-image: url(<?php echo get_theme_uri('images/background_02.jpeg'); ?>);">
            <div class="overlay"></div>
            <div class="container">
                <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

                    <div class="col-sm-12 ftco-animate text-center">
                        <h1 class="mb-2">Banyak Gratis Ongkir</h1>
                        <h2 class="subheading mb-4">Makeup dengan Brand-Brand Ternama</h2>
                        <p><a href="#products" class="btn btn-primary">Belanja Sekarang!</a></p>
                    </div>
            ...
            <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
                <div class="media block-6 services mb-md-0 mb-4">
                    ...
                    <div class="media-body">
                        ...
                        <span>Makeup Bersertifikat</span>
                    </div>
                </div>
            </div>
            <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
